...
@Component({
  selector: 'Fellowship-home',
  templateUrl: './Fellowship-home.component.html',
  styleUrls: ['./Fellowship-home.component.scss']
})
export class FellowshipHomeComponent implements AfterViewInit {
