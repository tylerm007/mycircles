...
@Component({
  selector: 'CardSelection-home',
  templateUrl: './CardSelection-home.component.html',
  styleUrls: ['./CardSelection-home.component.scss']
})
export class CardSelectionHomeComponent implements AfterViewInit {
