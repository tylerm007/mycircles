...
@Component({
  selector: 'CardTag-home',
  templateUrl: './CardTag-home.component.html',
  styleUrls: ['./CardTag-home.component.scss']
})
export class CardTagHomeComponent implements AfterViewInit {
