...
@Component({
  selector: 'Cardtype-home',
  templateUrl: './Cardtype-home.component.html',
  styleUrls: ['./Cardtype-home.component.scss']
})
export class CardtypeHomeComponent implements AfterViewInit {
