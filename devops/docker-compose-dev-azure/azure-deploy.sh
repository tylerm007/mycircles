...
projectname="mycircles"  # lower case, only
resourcegroup="mycircles_rg"
...
# git clone https://github.com/apilogicserver/mycircles.git
# cd mycircles
...
az webapp create --resource-group $resourcegroup --plan myAppServicePlan --name mycircles --multicontainer-config-type compose --multicontainer-config-file devops/docker-compose-dev-azure/docker-compose-dev-azure.yml
