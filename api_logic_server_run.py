...
#
#    (v 15.00.26, June 25, 2025 21:40:01)
#
...
api_logic_server__version = '15.00.26'
api_logic_server_created__on = 'June 25, 2025 21:40:01'
...
if __name__ == "__main__":
    msg = f'API Logic Project loaded (not WSGI), version: 15.00.26\n'
    ...
    msg = f'API Logic Project Loaded (WSGI), version 15.00.26\n'
    msg += f'.. startup message: {start_up_message}\n'
